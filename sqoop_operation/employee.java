...
//
// Debug information:
// Generated date: Mon Feb 21 10:02:47 IST 2022
...
public class employee extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("city", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        employee.this.city = (String)value;
      }
    });
    setters.put("dep", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        employee.this.dep = (String)value;
      }
    });
    setters.put("id", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        employee.this.id = (Integer)value;
      }
    });
    setters.put("name", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        employee.this.name = (String)value;
      }
    });
  }
  public employee() {
  ...
  public employee with_city(String city) {
    this.city = city;
    return this;
  }
  private String dep;
  ...
  public employee with_dep(String dep) {
    this.dep = dep;
    return this;
  }
  private Integer id;
  ...
  public boolean equals(Object o) {
    ...
    equal = equal && (this.dep == null ? that.dep == null : this.dep.equals(that.dep));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.dep = JdbcWritableBridge.readString(2, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(dep, 2 + __off, 12, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    this.dep = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
        this.id = null;
    } else {
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.dep) { 
        ...
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, dep);
    }
    if (null == this.id) { 
        __dataOut.writeBoolean(true);
    } else {
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(FieldFormatter.escapeAndEnclose(dep==null?"null":dep, delimiters));
    __sb.append(fieldDelim);
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null")) { this.dep = null; } else {
      this.dep = __cur_str;
    }
  ...
  public Map<String, Object> getFieldMap() {
    ...
    __sqoop$field_map.put("dep", this.dep);
